      ...
      body: SingleChildScrollView(
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Text("Тіркелу", style: TextStyle(fontSize: 32, fontWeight: FontWeight.w600, height: 2),),
              ...
              ElevatedButton(onPressed: () {
                ...
                child: Container(
                  ...
                  child: Center(child: Text('Тіркелу')),
                ),),
              SizedBox(height: 30,),
              Row(
                ...
                child: Container(
                  ...
                  child: RichText(
                      ...
                      text: TextSpan(
                        ...
                        children: <TextSpan>[
                          TextSpan(text: " Кіру", style: TextStyle(color: Colors.blue),
